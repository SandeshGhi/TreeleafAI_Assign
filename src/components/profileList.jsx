...
const ProfileList = ({ entries, setEntries, deleteEntry, editEntry }) => {
  ...
  return (
    <div className="mt-16 text-center font-bold">
      <h2 className="text-2xl font-semibold mb-4">User Entries</h2>
        <div className='lg:invisible visible text-center ml-6 text-yellow-400 bg-black font-bold text-2xl mt-4 lg:h-0 w-[350px]'>
      ...
      <div className='text-center'>
        <Link to="/">
          <button className='mt-8 border border-1 border-black rounded-lg w-[400px] text-center h-10 bg-red-800 font-bold text-white'>Back To Home</button>
        </Link>
      </div>
      <div className='text-center text-yellow-400 bg-black font-bold text-2xl mt-4'>
        <h1 className='animate-pulse'>If not updated Reload the Page!!!!!</h1>
      </div>
    </div>
  );
};
